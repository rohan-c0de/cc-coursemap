...
Neighbors handle this differently: Maryland leaves the details to each county's community college, so policies vary — see the [Maryland senior tuition waiver breakdown](/blog/maryland-senior-citizens-community-college-tuition-waiver) to compare. And North Carolina sets the threshold at 65 rather than 60, and limits the waiver to auditing only — see [how North Carolina's program works](/blog/north-carolina-senior-citizens-community-colleges) if you're near the state line or considering options across both states.
