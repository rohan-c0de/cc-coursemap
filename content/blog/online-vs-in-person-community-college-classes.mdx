...
<ProductCallout
  text="Community College Path lets you filter courses by format — online, in-person, hybrid — across all colleges in your state. Compare what's available before you commit."
  feature="courses"
...
Online isn't easier. Hybrid isn't just "online with occasional campus visits." Zoom classes aren't the same as asynchronous ones. Know what you're signing up for, and you'll make a better choice. And once you've settled on a format, make sure the course itself is a good transfer bet — [Virginia's VCCS transfer system](/blog/virginia-community-college-transfer-guaranteed-admission) and [Massachusetts's MassTransfer database](/blog/massachusetts-community-college-transfer-credit-guide) are both worth checking before you register, since the same online course can have very different transfer outcomes depending on the receiving university.
