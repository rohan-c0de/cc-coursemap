...
For a Southern neighbor comparison, [North Carolina's NCCCS session guide](/blog/north-carolina-community-college-session-timing-guide) covers the largest community college system in the Southeast by college count — 58 colleges, many with deep 8-week and mini-session menus, but without VCCS's dynamic-dated sections. NCCCS's Central Piedmont CC (49 distinct start dates) is the closest comparable to VCCS's Tidewater CC (74).
