...
<ProductCallout
  text="Community College Path shows how South Carolina technical college courses map to universities — check equivalencies before you register."
  href="/sc/transfer"
...
2. **Look up the course equivalency.** Use the Transfer Equivalency database or Community College Path to see how your intended course maps to that university. Pay attention to whether it's a direct match or elective credit.
...
Students who transfer efficiently from SC technical colleges are the ones who treat course selection as a transfer decision from day one — not something to figure out later. South Carolina's framework sits between Virginia's structured Guaranteed Admission Agreements — [see how VCCS guaranteed admission works](/blog/virginia-community-college-transfer-guaranteed-admission) — and Georgia's more fragmented course-by-course system; [comparing transfer credit across states](/blog/comparing-transfer-credit-across-states) gives context for where SC's 39% direct-match rate lands nationally.
