...
- ⚠️ Lightly covered (hub-only): transfer-receiver patterns (1 hub live 2026-05-11: `which-universities-are-toughest-transfer-receivers` — detector pending per issue #367)
...
| `transfer-receiver-patterns-guide` ✅ hub live (2026-05-11), detector pending | (hub: `which-universities-are-toughest-transfer-receivers`) | new: aggregate `data/{state}/transfer-equiv.json` per receiver, score by % direct match; emit state-by-receiver spoke candidates | §1 Transfer confusion | [#367](https://github.com/rohan-c0de/cc-coursemap/issues/367) |
